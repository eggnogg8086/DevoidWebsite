                ...
                <div class="misinformationDisinfo">
                    <p>Disinformation is deliberately spreading false information for an agenda. Misinformation, more often than not, arises from the lack of awareness of information.</p>
                       <p>While disinformation may have more severe consequences, Misinformation still harms the ingenuity of media and content shared in social media.</p> 
                        <p>Given the emotions and upbringings from different ideologies and groups, it's more likely to affect a citizen's judgment when sharing their
                        opinions about their favored candidates online.</p>
                </div>
            </div>
                ...
                <div class="misinformationFacebook-container">
                    ...
                    <div class="misinformationFacebook-partners">
                        <div class="misinformationFacebook-sites">
                            <a class="factcheckerLink" href="https://www.rappler.com/"> <img class="factcheckerLogo" src="../misinformation/images/rapplerLogo.png" alt="rapplerLogo"></a>
                            <span class="factcheckerName">Rappler</span>
                        </div>
                        <div class="misinformationFacebook-sites">
                            <a class="factcheckerLink" href="https://www.afp.com/en/agency/afp-in-world/manilaphilippines"> <img class="factcheckerLogo" src="../misinformation/images/afpLogo.svg" alt="afpLogo"></a>
                            <span class="factcheckerName">Agence France Presse (AFP) - Philippines</span>
                        </div>
                        <div class="misinformationFacebook-sites">
                            <a class="factcheckerLink" href="https://verafiles.org/"> <img class="factcheckerLogo" src="../misinformation/images/verafilesLogo.svg" alt="verafilesLogo"></a>
                    ...
                    <p>They help Facebook review flagged and reported content by users as false. Upon review, they take action by
                    reducing false information visibility in the platform and show warning labels upon coming across these. They may also limit the reach of
                    users or pages taking part in spreading these or make it less likely for them to monetize content.</p></div>
                
            </div>
            <div class="main-container">
                <div class="misinformationConclusion">
                    <p>At the end of the day, Facebook is a social media platform through and through. It's designed to respond to engagement over accurate information.
                        Emotionally-charged and opinionated statements is what helps it become a more personalized and successful business model. The more that people engage
                        with content containing misinformation, the more that Facebook tailors these through your home screens regardless of whether you agree with it or not.</p>
